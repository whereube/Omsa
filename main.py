...
def show_chat_room(chat_id):
    ...
    return render_template("/message_page.html", user_id = user_id, chat_id = chat_id, linked_user = linked_user, chat_messages = chat_messages)
...
def handle_messages():
    ...
    return redirect ("/message_page/<chat_id>")
